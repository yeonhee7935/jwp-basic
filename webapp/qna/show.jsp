                                ...
                                <div class="qna-comment-slipp-articles">
                                    <c:forEach var="answer" items="${answers}">
                                        <article class="article" id="answer-${answer.answerId}">
                                            <div class="article-header">
                                                <div class="article-header-thumb">
                                                    <img src="https://graph.facebook.com/v2.3/${answer.writer}/picture"
                                                         class="article-author-thumb" alt="">
                                                </div>
                                                <div class="article-header-text">
                                                    <a href="/users/${answer.writer}/자바지기" class="article-author-name">${answer.writer}</a>
                                                    <a href="#answer-${answer.answerId}" class="article-header-time"
                                                       title="퍼머링크">
                                                        ${answer.createdDate}
                                                    </a>
                                                </div>
                                                ...
                                                <ul class="article-util-list">
                                                    <li>
                                                        <a class="link-modify-article"
                                                           href="/questions/${answer.questionId}/answers/${answer.answerId}/form">수정</a>
                                                    </li>
                                                    <li>
                                                        <form class="form-delete"
                                                              action="/questions/${answer.questionId}/answers/${answer.answerId}"
                                                              method="POST">
                                                            <input type="hidden" name="_method" value="DELETE">
                                                            <button type="submit" class="link-delete-article">삭제
                                                            </button>
                                                        </form>
                                                    </li>
                                                </ul>
